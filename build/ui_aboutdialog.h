...
"Copyright &copy; 2011-YYYY The Joblocks developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Joblocks", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Joblocks</b> version", 0));
